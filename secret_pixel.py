...
def main():
    parser = argparse.ArgumentParser(description='SecretPixel - Advanced Steganography Tool', epilog="Example commands:\n"
                                            "  Hide: python secret_pixel.py hide host.png secret.txt public.pub output.png\n"
                                            "  Extract: python secret_pixel.py extract carrier.png private.pem [extracted.txt]",
                                     formatter_class=argparse.RawDescriptionHelpFormatter)
    subparsers = parser.add_subparsers(dest='command')

    # Subparser for hiding a file
    hide_parser = subparsers.add_parser('hide', help='Hide a file inside an image', epilog="Example: python secret_pixel.py hide host.png secret.txt public.pub output.png", formatter_class=argparse.RawDescriptionHelpFormatter)
    ...
    extract_parser = subparsers.add_parser('extract', help='Extract a file from an image', epilog="Example: python secret_pixel.py extract carrier.png  private.pem [extracted.txt]",
                                           formatter_class=argparse.RawDescriptionHelpFormatter)
